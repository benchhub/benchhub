...
const (
	...
	NodeState_NODE_JOB_WAITING_PEERS NodeState = 5
	NodeState_NODE_JOB_REPORTING     NodeState = 6
	NodeState_NODE_JOB_CLEANUP       NodeState = 7
)
...
var NodeState_name = map[int32]string{
	...
	2: "NODE_IDLE",
	3: "NODE_JOB_RUNNING",
	5: "NODE_JOB_WAITING_PEERS",
	6: "NODE_JOB_REPORTING",
	7: "NODE_JOB_CLEANUP",
}
...
type JobStagePipelineStatus int32

const (
	JobStagePipelineStatus_UNKNOWN_JOB_STAGE_PIPELINE_STATUS JobStagePipelineStatus = 0
	JobStagePipelineStatus_JOB_STAGE_PIPELINE_QUEUED         JobStagePipelineStatus = 1
	JobStagePipelineStatus_JOB_STAGE_PIPELINE_RUNNING        JobStagePipelineStatus = 2
	JobStagePipelineStatus_JOB_STAGE_PIPELINE_FINISHED       JobStagePipelineStatus = 3
	JobStagePipelineStatus_JOB_STAGE_PIPELINE_BACKGROUND     JobStagePipelineStatus = 4
)

var JobStagePipelineStatus_name = map[int32]string{
	0: "UNKNOWN_JOB_STAGE_PIPELINE_STATUS",
	1: "JOB_STAGE_PIPELINE_QUEUED",
	2: "JOB_STAGE_PIPELINE_RUNNING",
	3: "JOB_STAGE_PIPELINE_FINISHED",
	4: "JOB_STAGE_PIPELINE_BACKGROUND",
}
var JobStagePipelineStatus_value = map[string]int32{
	"UNKNOWN_JOB_STAGE_PIPELINE_STATUS": 0,
	"JOB_STAGE_PIPELINE_QUEUED":         1,
	"JOB_STAGE_PIPELINE_RUNNING":        2,
	"JOB_STAGE_PIPELINE_FINISHED":       3,
	"JOB_STAGE_PIPELINE_BACKGROUND":     4,
}

func (x JobStagePipelineStatus) String() string {
	return proto.EnumName(JobStagePipelineStatus_name, int32(x))
}
func (JobStagePipelineStatus) EnumDescriptor() ([]byte, []int) { return fileDescriptorTypes, []int{7} }

type StageTaskPipelineStatus int32

const (
	StageTaskPipelineStatus_UNKNOWN_STAGE_TASK_PIPELINE_STATUS StageTaskPipelineStatus = 0
	StageTaskPipelineStatus_STAGE_TASK_PIPELINE_QUEUED         StageTaskPipelineStatus = 1
	StageTaskPipelineStatus_STAGE_TASK_PIPELINE_RUNNING        StageTaskPipelineStatus = 2
	StageTaskPipelineStatus_STAGE_TASK_PIPELINE_FINISHED       StageTaskPipelineStatus = 3
	StageTaskPipelineStatus_STAGE_TASK_PIPELINE_BACKGROUND     StageTaskPipelineStatus = 4
)

var StageTaskPipelineStatus_name = map[int32]string{
	0: "UNKNOWN_STAGE_TASK_PIPELINE_STATUS",
	1: "STAGE_TASK_PIPELINE_QUEUED",
	2: "STAGE_TASK_PIPELINE_RUNNING",
	3: "STAGE_TASK_PIPELINE_FINISHED",
	4: "STAGE_TASK_PIPELINE_BACKGROUND",
}
var StageTaskPipelineStatus_value = map[string]int32{
	"UNKNOWN_STAGE_TASK_PIPELINE_STATUS": 0,
	"STAGE_TASK_PIPELINE_QUEUED":         1,
	"STAGE_TASK_PIPELINE_RUNNING":        2,
	"STAGE_TASK_PIPELINE_FINISHED":       3,
	"STAGE_TASK_PIPELINE_BACKGROUND":     4,
}

func (x StageTaskPipelineStatus) String() string {
	return proto.EnumName(StageTaskPipelineStatus_name, int32(x))
}
func (StageTaskPipelineStatus) EnumDescriptor() ([]byte, []int) { return fileDescriptorTypes, []int{8} }
...
type Job struct {
	...
	Pipelines        []JobStagePipeline `protobuf:"bytes,12,rep,name=pipelines" json:"pipelines"`
	Stages           []JobStage         `protobuf:"bytes,13,rep,name=stages" json:"stages"`
}
...
type JobStagePipeline struct {
	Status JobStagePipelineStatus `protobuf:"varint,1,opt,name=status,proto3,enum=bh.JobStagePipelineStatus" json:"status,omitempty"`
	Stages []int64                `protobuf:"varint,2,rep,packed,name=stages" json:"stages,omitempty"`
}

func (m *JobStagePipeline) Reset()                    { *m = JobStagePipeline{} }
func (m *JobStagePipeline) String() string            { return proto.CompactTextString(m) }
func (*JobStagePipeline) ProtoMessage()               {}
func (*JobStagePipeline) Descriptor() ([]byte, []int) { return fileDescriptorTypes, []int{23} }
...
type JobStage struct {
	...
	Nodes    []NodeJobStage `protobuf:"bytes,4,rep,name=nodes" json:"nodes"`
}

func (m *JobStage) Reset()                    { *m = JobStage{} }
func (m *JobStage) String() string            { return proto.CompactTextString(m) }
func (*JobStage) ProtoMessage()               {}
func (*JobStage) Descriptor() ([]byte, []int) { return fileDescriptorTypes, []int{24} }

type NodeJobStage struct {
	Id        string              `protobuf:"bytes,1,opt,name=id,proto3" json:"id,omitempty"`
	Name      string              `protobuf:"bytes,2,opt,name=name,proto3" json:"name,omitempty"`
	...
	Pipelines []StageTaskPipeline `protobuf:"bytes,5,rep,name=pipelines" json:"pipelines"`
	Tasks     []Task              `protobuf:"bytes,6,rep,name=tasks" json:"tasks"`
}

func (m *NodeJobStage) Reset()                    { *m = NodeJobStage{} }
func (m *NodeJobStage) String() string            { return proto.CompactTextString(m) }
func (*NodeJobStage) ProtoMessage()               {}
func (*NodeJobStage) Descriptor() ([]byte, []int) { return fileDescriptorTypes, []int{25} }

type StageTaskPipeline struct {
	Status StageTaskPipelineStatus `protobuf:"varint,1,opt,name=status,proto3,enum=bh.StageTaskPipelineStatus" json:"status,omitempty"`
	Tasks  []int64                 `protobuf:"varint,2,rep,packed,name=tasks" json:"tasks,omitempty"`
}

func (m *StageTaskPipeline) Reset()                    { *m = StageTaskPipeline{} }
func (m *StageTaskPipeline) String() string            { return proto.CompactTextString(m) }
func (*StageTaskPipeline) ProtoMessage()               {}
func (*StageTaskPipeline) Descriptor() ([]byte, []int) { return fileDescriptorTypes, []int{26} }
...
func (*Ping) Descriptor() ([]byte, []int) { return fileDescriptorTypes, []int{28} }
...
func (*Pong) Descriptor() ([]byte, []int) { return fileDescriptorTypes, []int{29} }
...
func (*EmptyReq) Descriptor() ([]byte, []int) { return fileDescriptorTypes, []int{30} }
...
func (*NodeInfoReq) Descriptor() ([]byte, []int) { return fileDescriptorTypes, []int{31} }
...
func (*NodeInfoRes) Descriptor() ([]byte, []int) { return fileDescriptorTypes, []int{32} }
...
func (*RegisterAgentReq) Descriptor() ([]byte, []int) { return fileDescriptorTypes, []int{33} }
...
func (*RegisterAgentRes) Descriptor() ([]byte, []int) { return fileDescriptorTypes, []int{34} }
...
func (*ListAgentReq) Descriptor() ([]byte, []int) { return fileDescriptorTypes, []int{35} }
...
func (*ListAgentRes) Descriptor() ([]byte, []int) { return fileDescriptorTypes, []int{36} }
...
func (*AgentHeartbeatReq) Descriptor() ([]byte, []int) { return fileDescriptorTypes, []int{37} }
...
func (*AgentHeartbeatRes) Descriptor() ([]byte, []int) { return fileDescriptorTypes, []int{38} }
...
func (*SubmitJobReq) Descriptor() ([]byte, []int) { return fileDescriptorTypes, []int{39} }
...
func (*SubmitJobRes) Descriptor() ([]byte, []int) { return fileDescriptorTypes, []int{40} }
...
func (*JobStatusReq) Descriptor() ([]byte, []int) { return fileDescriptorTypes, []int{41} }
...
func (*JobStatusRes) Descriptor() ([]byte, []int) { return fileDescriptorTypes, []int{42} }
...
func init() {
	...
	proto.RegisterType((*JobStagePipeline)(nil), "bh.JobStagePipeline")
	proto.RegisterType((*JobStage)(nil), "bh.JobStage")
	proto.RegisterType((*NodeJobStage)(nil), "bh.NodeJobStage")
	proto.RegisterType((*StageTaskPipeline)(nil), "bh.StageTaskPipeline")
	...
	proto.RegisterEnum("bh.JobStagePipelineStatus", JobStagePipelineStatus_name, JobStagePipelineStatus_value)
	proto.RegisterEnum("bh.StageTaskPipelineStatus", StageTaskPipelineStatus_name, StageTaskPipelineStatus_value)
...
func (m *JobStagePipeline) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalTo(dAtA)
	if err != nil {
...
func (m *JobStagePipeline) MarshalTo(dAtA []byte) (int, error) {
	var i int
	_ = i
	var l int
	_ = l
...
func (m *JobStage) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalTo(dAtA)
	if err != nil {
...
func (m *JobStage) MarshalTo(dAtA []byte) (int, error) {
	var i int
	_ = i
	var l int
	_ = l
...
func (m *NodeJobStage) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalTo(dAtA)
	if err != nil {
...
func (m *NodeJobStage) MarshalTo(dAtA []byte) (int, error) {
	var i int
	_ = i
	var l int
	_ = l
...
func (m *StageTaskPipeline) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalTo(dAtA)
	if err != nil {
...
func (m *StageTaskPipeline) MarshalTo(dAtA []byte) (int, error) {
	var i int
	_ = i
	var l int
	_ = l
...
func (m *RegisterAgentRes) MarshalTo(dAtA []byte) (int, error) {
	...
	n28, err := m.Central.MarshalTo(dAtA[i:])
	if err != nil {
		return 0, err
	}
	i += n28
...
func (m *JobStagePipeline) Size() (n int) {
	var l int
	_ = l
	if m.Status != 0 {
		n += 1 + sovTypes(uint64(m.Status))
...
func (m *NodeJobStage) Size() (n int) {
	var l int
	_ = l
	l = len(m.Id)
	if l > 0 {
...
func (m *StageTaskPipeline) Size() (n int) {
	var l int
	_ = l
	if m.Status != 0 {
		n += 1 + sovTypes(uint64(m.Status))
...
func (m *Job) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 12:
			...
			m.Pipelines = append(m.Pipelines, JobStagePipeline{})
			if err := m.Pipelines[len(m.Pipelines)-1].Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 13:
			...
			m.Stages = append(m.Stages, JobStage{})
			if err := m.Stages[len(m.Stages)-1].Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
...
func (m *JobStagePipeline) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: JobStagePipeline: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: JobStagePipeline: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 0 {
			...
			for shift := uint(0); ; shift += 7 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.Status |= (JobStagePipelineStatus(b) & 0x7F) << shift
				if b < 0x80 {
					break
				}
			}
...
func (m *JobStage) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: JobStage: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: JobStage: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 0 {
		...
		case 4:
			...
			m.Nodes = append(m.Nodes, NodeJobStage{})
...
func (m *NodeJobStage) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: NodeJobStage: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: NodeJobStage: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
		...
		case 5:
			...
			m.Pipelines = append(m.Pipelines, StageTaskPipeline{})
			if err := m.Pipelines[len(m.Pipelines)-1].Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
...
func (m *StageTaskPipeline) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: StageTaskPipeline: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: StageTaskPipeline: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 0 {
			...
			for shift := uint(0); ; shift += 7 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.Status |= (StageTaskPipelineStatus(b) & 0x7F) << shift
				if b < 0x80 {
					break
				}
			}
...
var fileDescriptorTypes = []byte{
	...
	,
}
